...
public final class i extends zza {
    public final xd.a n(xd.b bVar, String str, int i10) {
    ...
    public final xd.a u(xd.b bVar, String str, int i10, xd.b bVar2) {
        ...
        return gk.b.r(zzB(8, parcelZza));
    }

    public final xd.a v(xd.b bVar, String str, int i10) {
        Parcel parcelZza = zza();
        zzc.zze(parcelZza, bVar);
        parcelZza.writeString(str);
        parcelZza.writeInt(i10);
        return gk.b.r(zzB(4, parcelZza));
    }
}
