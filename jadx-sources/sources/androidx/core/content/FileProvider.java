...
public class FileProvider extends ContentProvider {
    ...
    public static final String[] f863d = {"_display_name", "_size"};

    /* renamed from: e, reason: collision with root package name */
    public static final File f864e = new File("/");

    /* renamed from: f, reason: collision with root package name */
    public static final HashMap f865f = new HashMap();
    ...
    public static d d(Context context, String str) throws XmlPullParserException, IOException {
        d dVar = new d(str);
        ProviderInfo providerInfoResolveContentProvider = context.getPackageManager().resolveContentProvider(str, 128);
        if (providerInfoResolveContentProvider == null) {
            throw new IllegalArgumentException(m1.i("Couldn't find meta-data for provider with authority ", str));
        }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    externalStorageDirectory = f864e;
                ...
                if (externalStorageDirectory == null) {
                    ...
                    try {
                        dVar.f8343b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e10) {
    ...
    public final d b() {
        ...
        synchronized (this.f866a) {
            try {
                ...
                if (this.f868c == null) {
                    this.f868c = c(getContext(), this.f867b);
                }
                dVar = this.f868c;
            } catch (Throwable th2) {
                throw th2;
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) throws IOException {
        ...
        if ("r".equals(str)) {
            ...
            if (!"rwt".equals(str)) {
                throw new IllegalArgumentException(m1.i("Invalid mode: ", str));
            }
            i10 = 1006632960;
        }
