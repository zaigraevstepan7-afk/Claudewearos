...
public class u extends ImageView {
    ...
    public final m f11192a;

    /* renamed from: b, reason: collision with root package name */
    public final ak.x f11193b;
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f11193b.f743c).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        ak.x xVar = this.f11193b;
        if (xVar != null && drawable != null && !this.f11194c) {
