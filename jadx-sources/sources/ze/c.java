...
public abstract class c {
    ...
    public static final ThreadLocal f20535a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f20536b = new ThreadLocal();

    public static void a(TextInputLayout textInputLayout, View view, Rect rect) {
        rect.set(0, 0, view.getWidth(), view.getHeight());
        ThreadLocal threadLocal = f20535a;
        ...
        ThreadLocal threadLocal2 = f20536b;
