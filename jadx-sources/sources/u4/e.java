...
public final class e {
    ...
    public final AccessibilityNodeInfo f16615a;

    /* renamed from: b, reason: collision with root package name */
    public int f16616b = -1;

    /* renamed from: c, reason: collision with root package name */
    public int f16617c = -1;

    public e(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f16615a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f16615a.addAction(i10);
    }

    public final void b(c cVar) {
        this.f16615a.addAction((AccessibilityNodeInfo.AccessibilityAction) cVar.f16611a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f16615a;
    ...
    public final boolean e(int i10) {
        Bundle extras = this.f16615a.getExtras();
    ...
    public final boolean equals(Object obj) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo2 = this.f16615a;
        ...
        return this.f16617c == eVar.f16617c && this.f16616b == eVar.f16616b;
    }

    public final void f(Rect rect) {
        this.f16615a.getBoundsInParent(rect);
    }
    ...
    public final void i(CharSequence charSequence) {
        this.f16615a.setClassName(charSequence);
    }

    public final void j(u0.b bVar) {
        this.f16615a.setCollectionInfo(null);
    }

    public final void k(boolean z2) {
        this.f16615a.setScrollable(z2);
    }
    ...
    public final String toString() {
        ...
        if (i10 >= 34) {
            v.c(accessibilityNodeInfo, rect);
        } else {
        ...
        sb2.append(i10 >= 30 ? i4.b.f(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY"));
        sb2.append("; contentDescription: ");
        sb2.append(accessibilityNodeInfo.getContentDescription());
        sb2.append("; supplementalDescription: ");
        sb2.append(i10 >= 36 ? d.c(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.SUPPLEMENTAL_DESCRIPTION_KEY"));
        ...
        sb2.append("; uniqueId: ");
        sb2.append(i10 >= 33 ? p4.b.b(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY"));
        sb2.append("; checkable: ");
        sb2.append(accessibilityNodeInfo.isCheckable());
        sb2.append("; checked: ");
        int iA = i10 >= 36 ? d.a(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.CHECKED_KEY", accessibilityNodeInfo.isChecked() ? 1 : 0);
        String str = "PARTIAL";
        sb2.append(iA == 1 ? "TRUE" : iA == 2 ? "PARTIAL" : "FALSE");
        sb2.append("; fieldRequired: ");
        sb2.append(i10 >= 36 ? d.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getBoolean("androidx.view.accessibility.AccessibilityNodeInfoCompat.IS_REQUIRED_KEY"));
        ...
        int iB = i10 >= 36 ? d.b(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.EXPANDED_STATE_KEY", 0);
        if (iB == 0) {
            str = "UNDEFINED";
        } else if (iB == 1) {
            str = "COLLAPSED";
        ...
        sb2.append(i10 >= 34 ? v.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.CONTAINER_TITLE_KEY"));
        ...
        sb2.append(i10 >= 33 ? p4.b.c(accessibilityNodeInfo) : e(8388608));
        sb2.append("; accessibilityDataSensitive: ");
        sb2.append(i10 >= 34 ? v.g(accessibilityNodeInfo) : e(64));
        sb2.append("; [");
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = accessibilityNodeInfo.getActionList();
        ArrayList arrayList = new ArrayList();
        int size = actionList.size();
        for (int i11 = 0; i11 < size; i11++) {
            arrayList.add(new c(actionList.get(i11), 0, null, null, null));
        }
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            c cVar = (c) arrayList.get(i12);
            int iA2 = cVar.a();
            Object obj = cVar.f16611a;
            String strD = d(iA2);
