...
public abstract class k extends h implements List, RandomAccess {
    ...
    public static final i f9584b = new i(m.f9588d, 0);
            ...
            if (size == list.size()) {
                ...
                while (true) {
                    if (iVarListIterator.hasNext()) {
                        if (!it.hasNext() || ((next = iVarListIterator.next()) != (next2 = it.next()) && (next == null || !next.equals(next2)))) {
                            break;
                        }
                    } else if (!it.hasNext()) {
                        return true;
    ...
    public k subList(int i10, int i11) {
        u6.v.m(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? m.f9588d : new j(this, i10, i12);
    }
    ...
    public final i listIterator(int i10) {
        ...
        return isEmpty() ? f9584b : new i(this, i10);
    }
}
