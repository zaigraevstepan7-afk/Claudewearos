...
public final class w extends b {
    public static w b(j jVar, d8.e eVar, Integer num) throws GeneralSecurityException {
        ...
        if (aVar.f1773a.length != 32) {
            throw new GeneralSecurityException("XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not " + aVar.f1773a.length);
        }
        if (jVar == jVar2) {
            bg.a.a(new byte[0]);
        } else if (jVar == j.f12469p) {
