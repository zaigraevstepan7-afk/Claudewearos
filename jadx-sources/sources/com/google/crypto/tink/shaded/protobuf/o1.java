...
public final class o1 extends u6.v {
    ...
    public static int p0(long j, byte[] bArr, int i10, int i11) {
        if (i11 == 0) {
            u6.v vVar = q1.f4215a;
            if (i10 > -12) {
                return -1;
        ...
        if (i11 == 1) {
            return q1.c(i10, n1.g(bArr, j));
        }
        if (i11 == 2) {
            return q1.d(i10, n1.g(bArr, j), n1.g(bArr, j + 1));
        }
    ...
    */
    public final java.lang.String B(int r11, byte[] r12, int r13) throws com.google.crypto.tink.shaded.protobuf.c0 {
        /*
            Method dump skipped, instructions count: 352
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.o1.B(int, byte[], int):java.lang.String");
    }
            ...
            default:
                ...
                while (i22 < length2) {
                    ...
                    if (cCharAt5 < c6 && j11 < j12) {
                        ...
                        if ((cCharAt5 >= '\ud800' && '\udfff' >= cCharAt5) || j11 > j12 - 3) {
                            ...
                            if (i23 != length2) {
                                ...
                                if (Character.isSurrogatePair(cCharAt5, cCharAt6)) {
                                    ...
                                    n1.k(bArr, j13, (byte) ((codePoint2 >>> 18) | 240));
                                    c10 = '\u0080';
                                    n1.k(bArr, j13 + j4, (byte) (((codePoint2 >>> 12) & 63) | 128));
                                    n1.k(bArr, j13 + 2, (byte) (((codePoint2 >>> 6) & 63) | 128));
                                    n1.k(bArr, j13 + 3, (byte) ((codePoint2 & 63) | 128));
                                    j10 = j13 + 4;
                                    i22 = i23;
                                } else {
                                    i22 = i23;
                        ...
                        n1.k(bArr, j11, (byte) ((cCharAt5 >>> '\f') | 480));
                        long j14 = j11;
                        n1.k(bArr, j11 + j4, (byte) (((cCharAt5 >>> 6) & 63) | 128));
                        j10 = j14 + 3;
                        n1.k(bArr, j14 + 2, (byte) ((cCharAt5 & '?') | 128));
                        c10 = '\u0080';
                    } else {
                        j4 = j;
                        n1.k(bArr, j11, (byte) ((cCharAt5 >>> 6) | 960));
                        n1.k(bArr, j11 + j4, (byte) ((cCharAt5 & '?') | c6));
                        j10 = j11 + 2;
                        c10 = c6;
                    }
                    i22++;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int T(int r18, byte[] r19, int r20) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.o1.T(int, byte[], int):int");
    }
}
