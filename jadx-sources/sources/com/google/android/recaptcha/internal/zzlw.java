...
final class zzlw {
    public static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws zzje {
        if (!zze(b11)) {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i10) throws zzje {
        if (b10 < -62 || zze(b11)) {
            throw zzje.zzd();
        }
