...
public final class zzcu {
    ...
    public /* synthetic */ zzcu(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f10, int i10, int i11, float f11, int i12, int i13, float f12, float f13, float f14, boolean z2, int i14, int i15, float f15, int i16, zzct zzctVar) {
    ...
    public final Bundle zza() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence instanceof Spanned) {
                ArrayList<? extends Parcelable> arrayListZza = zzcx.zza((Spanned) charSequence);
