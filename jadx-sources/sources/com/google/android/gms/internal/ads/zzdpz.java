        ...
        if (jSONArray != null && str != null) {
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                ...
                try {
                    ...
                    n.D.f11582h.zzw(e10, "RtbAdapterMap.hasAtleastOneRegexMatch");
                }
                if ((((Boolean) t.f12227d.f12230c.zzb(zzbdc.zzlh)).booleanValue() ? Pattern.compile(strOptString, 2) : Pattern.compile(strOptString)).matcher(str).lookingAt()) {
                    return true;
                }
            }
        }
