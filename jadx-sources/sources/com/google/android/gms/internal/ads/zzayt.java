...
public final class zzayt {
    ...
    private static final ClassLoader zzb = zzayt.class.getClassLoader();
    ...
    public static void zzc(Parcel parcel) {
        ...
        if (iDataAvail > 0) {
            throw new BadParcelableException(m6.a.d(iDataAvail, "Parcel data not fully consumed, unread size: "));
        }
    }
