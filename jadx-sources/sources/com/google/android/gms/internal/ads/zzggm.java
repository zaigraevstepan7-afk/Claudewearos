...
public final class zzggm {
    ...
    public final zzggm zza(int i10) throws GeneralSecurityException {
        if (i10 != 12 && i10 != 16) {
    ...
    public final zzggm zzb(int i10) throws InvalidAlgorithmParameterException {
    ...
    public final zzggm zzc(int i10) {
        this.zzc = 16;
        return this;
    }
