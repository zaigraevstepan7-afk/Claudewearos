...
final class zzhbv extends zzhbu {
    ...
    */
    ...
    @Override // com.google.android.gms.internal.ads.zzhbu
    public final String zzb(byte[] bArr, int i10, int i11) throws zzgzk {
        int i12;
        ...
        while (i10 < i13) {
            ...
            if (zzhbt.zzd(b11)) {
                ...
                if (zzhbt.zzf(b11)) {
                    ...
                    i12 = i15 + 1;
                    i10 += 2;
                    zzhbt.zzc(b11, bArr[i16], cArr, i15);
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    zzhbt.zzb(b11, bArr[i16], bArr[i17], cArr, i15);
                } else {
                    if (i16 >= i13 - 2) {
                        throw new zzgzk("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    zzhbt.zza(b11, b13, b14, bArr[i18], cArr, i15);
                    i15 += 2;
                }
                i15 = i12;
            }
