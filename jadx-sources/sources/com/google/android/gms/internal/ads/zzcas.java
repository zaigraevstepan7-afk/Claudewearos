...
final class zzcas extends zzcat implements ViewTreeObserver.OnScrollChangedListener {
    private final WeakReference zza;

    public zzcas(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener) {
        super(view);
