...
public final class zzdp implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i10) throws zzdq {
        ...
        zzdr.zza(eGLDisplayEglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdr.zza(EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        ...
        String str = zzex.zza;
        zzdr.zza(z2, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        zzdr.zza(eGLContextEglCreateContext != null, "eglCreateContext failed");
        ...
        if (i10 == 1) {
            ...
            zzdr.zza(eGLSurfaceEglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdr.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurfaceEglCreatePbufferSurface, eGLSurfaceEglCreatePbufferSurface, eGLContextEglCreateContext), "eglMakeCurrent failed");
