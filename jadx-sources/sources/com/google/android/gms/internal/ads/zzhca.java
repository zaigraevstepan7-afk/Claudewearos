...
interface zzhca {
    void zzA(int i10, List list, boolean z2);

    void zzB(int i10, int i11);

    void zzC(int i10, List list, boolean z2);

    void zzD(int i10, long j);

    void zzE(int i10, List list, boolean z2);
    ...
    void zzd(int i10, zzgxn zzgxnVar);
    ...
    @Deprecated
    void zzq(int i10, Object obj, zzhaz zzhazVar);
    ...
    void zzv(int i10, Object obj, zzhaz zzhazVar);

    void zzw(int i10, Object obj);

    void zzx(int i10, int i11);

    void zzy(int i10, List list, boolean z2);

    void zzz(int i10, long j);
}
