...
class zzhbh extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i12 = 0;
        if (i11 >= 0) {
            int iCompareTo = comparable.compareTo(((zzhbd) this.zza[i11]).zza());
            if (iCompareTo > 0) {
                return -(i10 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int iCompareTo2 = comparable.compareTo(((zzhbd) this.zza[i13]).zza());
            if (iCompareTo2 < 0) {
                i11 = i13 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i10) {
        zzo();
        Object value = ((zzhbd) this.zza[i10]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i11] = new zzhbd(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            if (!zzg(i11).equals(zzhbhVar.zzg(i11))) {
                return false;
            }
        }
        if (i10 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i10] = new zzhbd(this, comparable, obj);
        this.zzb++;
        return null;
    }
