...
public final class zzach {
    ...
    */
    public static cg.k zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 546
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzach.zza(com.google.android.gms.common.api.Status):cg.k");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f8553a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f8553a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static k zza(Status status, c cVar, String str, String str2) {
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f3492b) ? str : String.format(m1.v(str, " [ %s ]"), status.f3492b);
    }

    public static j zza(FirebaseAuth firebaseAuth, zzym zzymVar, l lVar) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzymVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<q> listZzc = zzymVar.zzc();
        ...
        List<q> listZzc2 = zzymVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (q qVar2 : listZzc2) {
            if (qVar2 instanceof y) {
                arrayList2.add((y) qVar2);
            }
        }
        List<q> listZzc3 = zzymVar.zzc();
        String strZzb = zzymVar.zzb();
        e0.i(listZzc3);
        e0.e(strZzb);
        ArrayList arrayList3 = new ArrayList();
        ArrayList arrayList4 = new ArrayList();
        for (q qVar3 : listZzc3) {
            if (qVar3 instanceof v) {
                arrayList3.add((v) qVar3);
            } else if (qVar3 instanceof y) {
                arrayList4.add((y) qVar3);
            } else {
                throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(qVar3.b()));
            }
        }
        cg.i iVar = firebaseAuth.f4252a;
        iVar.b();
        String str3 = iVar.f3368b;
        zzymVar.zza();
        e0.e(str3);
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof i) {
            return ((i) exc).f8553a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
