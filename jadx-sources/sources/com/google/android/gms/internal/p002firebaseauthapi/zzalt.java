...
final class zzalt implements Comparable, Map.Entry {
    ...
    public zzalt(zzali zzaliVar, Map.Entry entry) {
    ...
    public final String toString() {
        return m1.w(String.valueOf(this.zza), "=", String.valueOf(this.zzb));
    }

    public zzalt(zzali zzaliVar, Comparable comparable, Object obj) {
        this.zzc = zzaliVar;
        this.zza = comparable;
        this.zzb = obj;
    }
