...
final class zzhk {
    public static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws zzfb {
        if (!zze(b11)) {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i10) throws zzfb {
        if (b10 < -62 || zze(b11)) {
            throw zzfb.zzb();
        }
