...
public class PlayCoreDialogWrapperActivity extends Activity {
    ...
    public ResultReceiver f3999a;

    @Override // android.app.Activity
    public final void onActivityResult(int i10, int i11, Intent intent) {
        ResultReceiver resultReceiver;
        super.onActivityResult(i10, i11, intent);
        if (i10 == 0 && (resultReceiver = this.f3999a) != null) {
            if (i11 == -1) {
    ...
    public final void onCreate(Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (bundle != null) {
            this.f3999a = (ResultReceiver) bundle.getParcelable("result_receiver");
            return;
        }
        this.f3999a = (ResultReceiver) getIntent().getParcelableExtra("result_receiver");
        ...
        if (extras == null || pendingIntent == null) {
            ResultReceiver resultReceiver = this.f3999a;
        ...
        try {
            ...
            try {
                ...
                ResultReceiver resultReceiver2 = playCoreDialogWrapperActivity.f3999a;
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        bundle.putParcelable("result_receiver", this.f3999a);
    }
}
